...
public class DartFromJsonGenerateHandler extends BaseDartGenerateHandler {
    @NotNull
    @Override
    protected BaseCreateMethodsFix<DartComponent> createFix(@NotNull DartClass dartClass) {
        return new CreateFromJsonFix(dartClass);
    }

    @NotNull
    @Override
    protected String getTitle() {
        return DartBundle.message("title.DartFromJsonGenerate.message");
    }
