...
import com.cofe.plugin.utils.DomUtil;
...
public class CreateFromJsonFix extends BaseCreateMethodsFix<DartComponent> {

    public CreateFromJsonFix(@NotNull DartClass dartClass) {
        super(dartClass);
    }
    ...
    protected Template buildFunctionsText(TemplateManager templateManager, Set<DartComponent> elementsToProcess) {
        ...
        for (DartComponent component : elementsToProcess) {
            ...
            String typeText = DomUtil.getReturnTypeText(component);
